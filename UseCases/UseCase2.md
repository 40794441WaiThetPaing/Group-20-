...
As a *Data Analyst*, I want *top N populated cities in the world where N is provided* so that *I can focus on major global cities*.

As a *Data Analyst*, I want *top N populated cities in a continent where N is provided* so that *I can analyze major cities continent-wide*.

As a *Data Analyst*, I want *top N populated cities in a region where N is provided* so that *I can focus on key cities in that region*.

As a *Data Analyst*, I want *top N populated cities in a country where N is provided* so that *I can analyze the largest cities nationally*.

As a *Data Analyst*, I want *top N populated cities in a district where N is provided* so that *I can review key cities locally*.
### Scope
...
3. Data Analyst captures Top N to see the most populated cities
