...
1. Data Analyst initiates a request for a population report.

2. The system retrieves total, urban and non-urban population data from the database.

3. The system generates and displays the report with the requested population breakdown.

### EXTENSIONS

2. **If scope or population data is missing or invalid**: 
     System requests correction or notifies the user that no data is available.
